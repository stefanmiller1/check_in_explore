...
class ActivityRuleMobileEditor extends StatefulWidget {
  ...
  const ActivityRuleMobileEditor({super.key, required this.model, required this.activityManagerForm, required this.reservation, required this.didSave});

  @override
  State<ActivityRuleMobileEditor> createState() => _ActivityRuleMobileEditorState();
}

class _ActivityRuleMobileEditorState extends State<ActivityRuleMobileEditor> {
