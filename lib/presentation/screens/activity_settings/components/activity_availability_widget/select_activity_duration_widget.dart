                            ...
                            children: DurationType.values.map(
                                ...
                                child: Container(
                                    ...
                                    child: TextButton(
                                      style: ButtonStyle(
                                        backgroundColor: MaterialStateProperty.resolveWith<Color>(
                                            ...
                                            if (states.contains(MaterialState.hovered)) {
                                              return (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.durationType == e) ? widget.model.paletteColor : widget.model.paletteColor.withOpacity(0.1);
                                            }
                                            return (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.durationType == e) ? widget.model.paletteColor : Colors.transparent; // Use the component's default.
                                          },
                                        ),
                                        ...
                                        setState(() {
                                          ...
                                          switch (e) {
                                             ...
                                             case DurationType.day:
                                               context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.endingDateChanged(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting.add(Duration(days: 1))));
                                               context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.hoursOpen.openHours.clear();
                                               context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.hoursOpen.openHours.addAll(AvailabilityHoursSettingOption.empty().openHours);
                                               context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.openHoursChanged(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.hoursOpen.openHours));
                                               break;
                                             case DurationType.week:

                                              context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.endingDateChanged(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting.add(Duration(days: 14))));
                                              dayOption.clear();
                                              context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.hoursOpen.openHours.clear();


                                              for (int week in [for(var i=0; i<((DateTimeRange(start: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting, end: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting.add(Duration(days: 14))).duration.inDays/7)); i+=1) i]) {

                                                dayOption.addAll([
                                                  DayOptionItem(month: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting.month, week: week, dayOfWeek: AvailabilityHoursSettingOption.empty().openHours[0].dayOfWeek, isClosed: AvailabilityHoursSettingOption.empty().openHours[0].isClosed, isTwentyFourHour: AvailabilityHoursSettingOption.empty().openHours[0].isTwentyFourHour, hoursOpen: []),
                                                  DayOptionItem(month: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting.month, week: week, dayOfWeek: AvailabilityHoursSettingOption.empty().openHours[1].dayOfWeek, isClosed: AvailabilityHoursSettingOption.empty().openHours[1].isClosed, isTwentyFourHour: AvailabilityHoursSettingOption.empty().openHours[0].isTwentyFourHour, hoursOpen: []),
                                                  DayOptionItem(month: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting.month, week: week, dayOfWeek: AvailabilityHoursSettingOption.empty().openHours[2].dayOfWeek, isClosed: AvailabilityHoursSettingOption.empty().openHours[2].isClosed, isTwentyFourHour: AvailabilityHoursSettingOption.empty().openHours[0].isTwentyFourHour, hoursOpen: []),
                                                  DayOptionItem(month: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting.month, week: week, dayOfWeek: AvailabilityHoursSettingOption.empty().openHours[3].dayOfWeek, isClosed: AvailabilityHoursSettingOption.empty().openHours[3].isClosed, isTwentyFourHour: AvailabilityHoursSettingOption.empty().openHours[0].isTwentyFourHour, hoursOpen: []),
                                                  DayOptionItem(month: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting.month, week: week, dayOfWeek: AvailabilityHoursSettingOption.empty().openHours[4].dayOfWeek, isClosed: AvailabilityHoursSettingOption.empty().openHours[4].isClosed, isTwentyFourHour: AvailabilityHoursSettingOption.empty().openHours[0].isTwentyFourHour, hoursOpen: []),
                                                  DayOptionItem(month: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting.month, week: week, dayOfWeek: AvailabilityHoursSettingOption.empty().openHours[5].dayOfWeek, isClosed: AvailabilityHoursSettingOption.empty().openHours[5].isClosed, isTwentyFourHour: AvailabilityHoursSettingOption.empty().openHours[0].isTwentyFourHour, hoursOpen: []),
                                                  DayOptionItem(month: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting.month, week: week, dayOfWeek: AvailabilityHoursSettingOption.empty().openHours[6].dayOfWeek, isClosed: AvailabilityHoursSettingOption.empty().openHours[6].isClosed, isTwentyFourHour: AvailabilityHoursSettingOption.empty().openHours[0].isTwentyFourHour, hoursOpen: []),
                                                ]);
                                              }

                                              context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.hoursOpen.openHours.addAll(dayOption);
                                              context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.openHoursChanged(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.hoursOpen.openHours));

                                              break;
                                             case DurationType.month:

                                               context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.endingDateChanged(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting.add(Duration(days: 29))));

                                               dayOption.clear();
                                               context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.hoursOpen.openHours.clear();


                                               for (int week in [for(var i=0; i<((DateTimeRange(start: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting, end: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting.add(Duration(days: 29))).duration.inDays/7)); i+=1) i]) {
                                             ...
                                             case DurationType.seasonal:
                                               dayOption.clear();
                                               context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.endingDateChanged(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting.add(Duration(days: 119))));
                                               context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.hoursOpen.openHours.clear();


                                               for (int week in [for(var i=0; i<((DateTimeRange(start: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting, end: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting.add(Duration(days: 119))).duration.inDays/7)); i+=1) i]) {
                                                 dayOption.addAll([
                                                   DayOptionItem(month: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting.month, week: week, dayOfWeek: AvailabilityHoursSettingOption.empty().openHours[0].dayOfWeek, isClosed: AvailabilityHoursSettingOption.empty().openHours[0].isClosed, isTwentyFourHour: AvailabilityHoursSettingOption.empty().openHours[0].isTwentyFourHour, hoursOpen: []),
                                                   DayOptionItem(month: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting.month, week: week, dayOfWeek: AvailabilityHoursSettingOption.empty().openHours[1].dayOfWeek, isClosed: AvailabilityHoursSettingOption.empty().openHours[1].isClosed, isTwentyFourHour: AvailabilityHoursSettingOption.empty().openHours[0].isTwentyFourHour, hoursOpen: []),
                                                   DayOptionItem(month: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting.month, week: week, dayOfWeek: AvailabilityHoursSettingOption.empty().openHours[2].dayOfWeek, isClosed: AvailabilityHoursSettingOption.empty().openHours[2].isClosed, isTwentyFourHour: AvailabilityHoursSettingOption.empty().openHours[0].isTwentyFourHour, hoursOpen: []),
                                            ...
                                            case DurationType.custom:
                                              ...
                                              dayOption.clear();
                                              context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.endingDateChanged(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting.add(Duration(days: 30))));
                                              context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.hoursOpen.openHours.clear();
                                              DateTime startTime = context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting;
                                              DateTime endTime = context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting.add(Duration(days: 29));
                                      ...
                                      child: Text(getDurationTypeName(context, e), style: TextStyle(color: (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.durationType == e) ? widget.model.accentColor : widget.model.paletteColor, fontWeight: (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.durationType == e) ? FontWeight.bold : FontWeight.normal)),
                                )
                              ),
                            ),
                          ).toList(),
                     ...
                     Row(
                      children: [
                        Expanded(
                          child: Column(
                              ...
                              Container(
                                ...
                                shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                                    ...
                                    child: Row(
                                      children: [
                                        Expanded(child: Text(DateFormat.yMMMMd().format(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting), style: TextStyle(color: widget.model.paletteColor, fontWeight: FontWeight.bold, fontSize: widget.model.secondaryQuestionTitleFontSize))),
                            ...
                            Expanded(
                              child: Visibility(
                                visible: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.durationType != DurationType.day,
                                child: IgnorePointer(
                                  ignoring: true,
                                  child: Column(
                                      mainAxisAlignment: MainAxisAlignment.start,
                                      ...
                                      children: [
                                        ...
                                        Container(
                                            ...
                                            child: TextButton(
                                              ...
                                              child: Row(
                                                children: [
                                                  Expanded(child: Text(DateFormat.yMMMMd().format(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromEnding), style: TextStyle(color: widget.model.paletteColor, fontWeight: FontWeight.bold, fontSize: widget.model.secondaryQuestionTitleFontSize), maxLines: 1, overflow: TextOverflow.ellipsis,)),
                                                  Icon(Icons.calendar_today_rounded, color: widget.model.paletteColor),
                                            ],
                                          ),
                                        )
                          ...
                          SizedBox(height: 25),
                          Visibility(
                            visible: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.durationType == DurationType.custom && _isShow,
                          ...
                          Visibility(
                            visible: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.durationType == DurationType.week && _isShow,
                            child: Container(
                              height: 500,
                              width: MediaQuery.of(context).size.width,
                              child: SfDateRangePicker(
                                initialSelectedDate: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting,
                                ...
                                monthViewSettings: DateRangePickerMonthViewSettings(
                                  firstDayOfWeek: 1,
                                  specialDates: getDaysInBetween(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting, context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting.add(Duration(days: 6))),
                                  blackoutDates: [getDaysInBetween(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting, context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting.add(Duration(days: 6))).last]
                                ),
                          ...
                          Visibility(
                            visible: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.durationType == DurationType.month && _isShow || context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.durationType == DurationType.seasonal && _isShow,
                            child: Container(
                              height: 500,
                              width: 500,
                              child: SfDateRangePicker(
                                ...
                                selectionMode: (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.durationType == DurationType.month) ? DateRangePickerSelectionMode.single : DateRangePickerSelectionMode.range,
                                todayHighlightColor: widget.model.paletteColor,
                                rangeTextStyle: TextStyle(
                                    color: widget.model.paletteColor.withOpacity(0.7)),
                                selectionTextStyle:  TextStyle(
                          ...
                          Visibility(
                            visible: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.durationType == DurationType.day && _isShow,
                            child: Container(
                              height: 500,
                              width: MediaQuery.of(context).size.width,
                              child: SfDateRangePicker(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              weekdayListOpenHours(
                                  ...
                                  null,
                                  model: widget.model,
                                  startDate: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting,
                                  endDate: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromEnding,
                                  durationType: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.durationType ?? DurationType.day,
                                  currentWeek: 0,
                                  hoursPerDay: [context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.hoursOpen.openHours.firstWhere((element) => (element.dayOfWeek) == (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting.weekday))],
                                  editWeekdays: (day) {
                                    showDialog(
                                        context: context,
                                        builder: (BuildContext contexts) {
                                          ...
                                          return ActivityHoursFilterWidget(
                                            model: widget.model,
                                            selectableWeeks: [],
                                            selectableWeekDay: [context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting.weekday],
                                            endDate: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromEnding,
                                            startDate: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting,
                                            ...
                                            saveOptions: (List<DayOptionItem> savedList, bool isTwentyFour, bool isClosed) {
                                              ...
                                              for (DayOptionItem dayOption in savedList) {
                                                int index = context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.hoursOpen.openHours.indexWhere((element) => element.dayOfWeek == dayOption.dayOfWeek);
                                                context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.hoursOpen.openHours.replaceRange(index, index+1, [dayOption]);
                                              }
