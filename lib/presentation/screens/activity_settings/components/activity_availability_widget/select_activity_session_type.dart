...
class _ActivitySessionTypeSelectionState extends State<ActivitySessionTypeSelection> {
  ...
  Widget build(BuildContext context) {
    ...
    if (((context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.sessionDetails?.length ?? 0) >= 2)) {
    ...
    return Center(
        ...
        child: SingleChildScrollView(
          ...
          children: [
                            ...
                            child: Row(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text((context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.sessionType == null) ? AppLocalizations.of(context)!.facilitiesSelect : getSessionTypeName(context, context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.sessionType ?? ActivitySessionType.recurring), style: TextStyle(color: widget.model.paletteColor, fontWeight:  FontWeight.normal, fontSize: 13.5 ),),
                                ),
                                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      RadioListTile(
                        toggleable: true,
                        value: 'DayBased',
                        groupValue: (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.isDayBased ?? false) ? 'DayBased' : null,
                        onChanged: (String? value) {

                          if (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.isDayBased ?? false) {
                      ...
                      RadioListTile(
                        toggleable: true,
                        value: 'TimeBased',
                        groupValue: !(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.isDayBased ?? true) ? 'TimeBased' : null,
                        onChanged: (String? value) {

                          if (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.isDayBased ?? true) {
                            context.read<UpdateActivityFormBloc>().add(UpdateActivityFormEvent.isDayBasedChanged(false));
                          } else {
                            context.read<UpdateActivityFormBloc>().add(UpdateActivityFormEvent.isDayBasedChanged(true));
                          }
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        onChanged: (String? value) {
                          ...
                          setState(() {
                            if (_sessionAmount == 'Single') {
                              ...
                              context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.sessionDetails?.clear();
                              AvailabilitySessionOption session = AvailabilitySessionOption(sessionPeriod: DateTimeRange(start: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting, end: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromEnding), sessionTitle: BackgroundInfoTitle(''), sessionDescription: BackgroundInfoDescription(''));
                      ...
                      RadioListTile(
                        toggleable: true,
                        value: 'MultiSession',
                        groupValue: ((context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.sessionDetails?.length ?? 0) >= 2) ? 'MultiSession' : _sessionAmount,
                        onChanged: (String? value) {
              ...
              Visibility(
                visible:  _sessionAmount == 'MultiSession' && context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.sessionType == ActivitySessionType.multiDay,
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.start,
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    Container(
                      ...
                      child: DropdownButtonHideUnderline(
                          child: DropdownButton2(
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Padding(
                                        padding: const EdgeInsets.only(left: 8.0),
                                        child: Text('${context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.sessionDetails?.length ?? 0} ${AppLocalizations.of(context)!.profileEventsActivityTableSessions}', style: TextStyle(color: widget.model.paletteColor, fontWeight: FontWeight.bold, fontSize: widget.model.secondaryQuestionTitleFontSize),),
                                      ),
                                      Padding(
                                        padding: const EdgeInsets.only(right: 8.0),
                                        child: Icon(Icons.keyboard_arrow_down_rounded, size: 45, color: widget.model.disabledTextColor),
                              ...
                              dropdownWidth: (widget.model.mainContentWidth)! - 100,
                              focusColor: Colors.grey.shade100,
                              items: [for(var i=0; i<(DateTimeRange(start: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting, end: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromEnding).duration.inDays + 1); i+=1) i].where((element) => element != 0).map(
                                      ...
                                      setState(() {
                                       for (int day in [for (var f=0; f<e; f+=1) f]) {
                                         ...
                                         if (day == 0) {
                                          ...
                                          AvailabilitySessionOption session = AvailabilitySessionOption(
                                              sessionPeriod: DateTimeRange(
                                                  start: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting,
                                                  end: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting.add(Duration(
                                                      days: getNumberOfRangeSessionsToAdd(e, DateTimeRange(start: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting, end: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromEnding).duration.inDays))
                                          )), sessionTitle: BackgroundInfoTitle(''), sessionDescription: BackgroundInfoDescription(''));
                                          context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.sessionDetails?.add(session);

                                          } else if (day >= 1 && day <= [for (var f=0; f<e; f+=1) f].length - 2) {

                                           AvailabilitySessionOption session = AvailabilitySessionOption(
                                               sessionPeriod: DateTimeRange(
                                                   start: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting.add(Duration(
                                                       days: day * getNumberOfRangeSessionsToAdd(e, DateTimeRange(start: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting, end: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromEnding).duration.inDays))),
                                                   end: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting.add(Duration(
                                                       days: (day * getNumberOfRangeSessionsToAdd(e, DateTimeRange(start: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting, end: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromEnding).duration.inDays)) + getNumberOfRangeSessionsToAdd(e, DateTimeRange(start: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting, end: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromEnding).duration.inDays))
                                                   )), sessionTitle: BackgroundInfoTitle(''), sessionDescription: BackgroundInfoDescription(''));
                                           ...
                                           AvailabilitySessionOption session = AvailabilitySessionOption(
                                               sessionPeriod: DateTimeRange(
                                                   start: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting.add(Duration(
                                                       days: day * getNumberOfRangeSessionsToAdd(e, DateTimeRange(start: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting, end: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromEnding).duration.inDays))),
                                                   end: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromEnding),
                                               sessionTitle: BackgroundInfoTitle(''), sessionDescription: BackgroundInfoDescription(''));
                                        ...
                                        context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.sessionsDetailsChanged(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.sessionDetails ?? []));
                                        });
                                      },
                                      value: e,
              ...
              Visibility(
                visible: (((context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.sessionDetails?.length ?? 0) >= 1) && context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.sessionType == ActivitySessionType.multiDay),
                  child: Column(
                  mainAxisAlignment: MainAxisAlignment.start,
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                                    ...
                                    showDialog(
                                        ...
                                        builder: (BuildContext contexts) {
                                          return ActivitySessionEditorWidget(
                                            ...
                                            sessionNumber: '${i+1}',
                                            previousTime: (i != 0) ? (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.sessionDetails?[i - 1].sessionPeriod.start.add(Duration(days: 1)) ?? DateTime.now()) : (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.sessionDetails?[i].sessionPeriod.start ?? DateTime.now()),
                                            saveSession: (AvailabilitySessionOption session) {

                                              context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.sessionDetails?.replaceRange(i, i+1, [session]);
              ...
              Visibility(
                visible: !(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.isDayBased ?? true) && context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.sessionType == ActivitySessionType.recurring,
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        RadioListTile(
                          toggleable: true,
                          value: '30Min',
                          groupValue: (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.isThirtyMinutesPer ?? false) ? '30Min' : null,
                          onChanged: (String? value) {

                            setState(() {
                              if (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.isThirtyMinutesPer ?? false) {
                        ...
                        RadioListTile(
                          toggleable: true,
                          value: '60Min',
                          groupValue: (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.isSixtyMinutesPer ?? false) ? '60Min' : null,
                          onChanged: (String? value) {

                            setState(() {
                              if (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.isSixtyMinutesPer ?? false) {
                              context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.isThirtyMinutesPerChanged(false));
                              context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.isSixtyMinutesPerChanged(false));
                              context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.isTwoHoursPerChanged(false));
                              } else {
                        ...
                        RadioListTile(
                          toggleable: true,
                          value: '2Hours',
                          groupValue: (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.isTwoHoursPer ?? false) ? '2Hours' : null,
                          onChanged: (String? value) {

                            setState(() {
                              if (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.isTwoHoursPer ?? false) {
                                context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.isThirtyMinutesPerChanged(false));
                                context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.isSixtyMinutesPerChanged(false));
                                context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.isTwoHoursPerChanged(false));
                              } else {
