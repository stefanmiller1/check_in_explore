...
class _ActivityAvailabilityHintHelperState extends State<ActivityAvailabilityHintHelper> {
  ...
  @override
  void initState() {
    _selectedDateToFilter = (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.hoursOpen.openHours.where((element) => element.isClosed == false).isNotEmpty) ? context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.hoursOpen.openHours.where((element) => element.isClosed == false).toList()[0] : null;
    ...
    return SingleChildScrollView(
      ...
      children: [
        ...
        Container(
          ...
          child: Padding(
            padding: const EdgeInsets.all(8.0),
            child: Center(child: Text(getDurationTypeName(context, context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.durationType), style: TextStyle(color: widget.model.paletteColor, fontWeight: FontWeight.bold, fontSize: widget.model.questionTitleFontSize),)),
            ),
          ),
          SizedBox(height: 15),
      ...
      Visibility(
        visible: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.durationType != DurationType.day && context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.sessionType == ActivitySessionType.multiDay,
        child: Container(
            decoration: BoxDecoration(
            ...
            child: Padding(
              ...
              child: Column(
                  children: [
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text('Joining Means Access to All ${context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.sessionDetails?.length ?? 0} Unique Sessions:', style: TextStyle(
                      color: widget.model.accentColor,
                      fontWeight: FontWeight.bold)),
                    ),
                    SizedBox(height: 10),
                         ...
                         child: Column(
                           ...
                           children: [
                            Padding(
                              ...
                              child: Text('Activity Lasts ${DateFormat.MMMMd().format(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting)} - ${DateFormat.MMMMd().format(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromEnding)}', style: TextStyle(
                                 color: widget.model.paletteColor,
                                 fontWeight: FontWeight.bold)),
                            ),
                             ...context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.sessionDetails?.asMap().map((i, e) =>
                                 MapEntry(i, Padding(
                                     padding: const EdgeInsets.all(4.0),
                                     child: Container(
                                       decoration: BoxDecoration(
          ...
          Visibility(
            visible: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.durationType != DurationType.day && ((context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.hoursOpen.openHours.where((element) => element.isClosed == false).length) >= 1) && context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.sessionType == ActivitySessionType.recurring,
            child: Stack(
              ...
              children: [
                ...
                Container(
                  ...
                  child: PageView.builder(
                      ...
                      itemCount: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.hoursOpen.openHours.where((element) => element.isClosed == false).length,
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Expanded(child: Text(dayOfTheWeek(context, context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.hoursOpen.openHours.where((element) => element.isClosed == false).toList()[index].dayOfWeek), style: TextStyle(color: widget.model.accentColor, fontWeight: FontWeight.bold), overflow: TextOverflow.ellipsis)),
                                      SizedBox(width: 10),
                                      Visibility(
                      ...
                      onPageChanged: (p) {
                        setState(() {
                        _selectedDateToFilter = context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.hoursOpen.openHours.where((element) => element.isClosed == false).toList()[p];
                      });
                    },
                  ),
                ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Visibility(
                          ...
                          child: Column(
                            children: [
                              Text(AppLocalizations.of(context)!.activityAvailabilitySessionsBreakdown((context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.hoursOpen.openHours.where((element) => element.isClosed == false).toList().length).toString(), 'Full Day', AppLocalizations.of(context)!.week), style: TextStyle(
                                  color: widget.model.paletteColor,
                        ...
                        Visibility(
                          ...
                          child: Column(
                            children: [
                              Visibility(
                                visible: ((context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.isThirtyMinutesPer ?? false) && !(_selectedDateToFilter?.isTwentyFourHour ?? true)),
                              ...
                              Visibility(
                                visible: ((context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.isSixtyMinutesPer ?? false) && !(_selectedDateToFilter?.isTwentyFourHour ?? true)),
                              ...
                              Visibility(
                                visible: ((context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.isTwoHoursPer ?? false) && !(_selectedDateToFilter?.isTwentyFourHour ?? true)),
                              ...
                              Visibility(
                              visible: ((context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.isThirtyMinutesPer ?? false) && (_selectedDateToFilter?.isTwentyFourHour ?? false)),
                              ...
                              Visibility(
                                visible: ((context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.isSixtyMinutesPer ?? false) && (_selectedDateToFilter?.isTwentyFourHour ?? false)),
                              ...
                              Visibility(
                                visible: ((context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.isTwoHoursPer ?? false) && (_selectedDateToFilter?.isTwentyFourHour ?? false)),
                                          ...
                                          Expanded(
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                if (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.isThirtyMinutesPer ?? false) Text('Slot: ${DateFormat.jm().format(_selectedDateToFilter?.hoursOpen.first.start.add(Duration(minutes: (30 * e))) ?? DateTime.now())}', style: TextStyle(color: widget.model.accentColor, fontWeight: FontWeight.bold, fontSize: widget.model.secondaryQuestionTitleFontSize)),
                                                if (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.isSixtyMinutesPer ?? false) Text('Slot: ${DateFormat.jm().format(_selectedDateToFilter?.hoursOpen.first.start.add(Duration(minutes: (60 * e))) ?? DateTime.now())}', style: TextStyle(color: widget.model.accentColor, fontWeight: FontWeight.bold, fontSize: widget.model.secondaryQuestionTitleFontSize)),
                                                if (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.isTwoHoursPer ?? false) Text('Slot: ${DateFormat.jm().format(_selectedDateToFilter?.hoursOpen.first.start.add(Duration(minutes: (120 * e))) ?? DateTime.now())}', style: TextStyle(color: widget.model.accentColor, fontWeight: FontWeight.bold, fontSize: widget.model.secondaryQuestionTitleFontSize)),
                                              ],
                                            ),
                                          )
                                        ],
