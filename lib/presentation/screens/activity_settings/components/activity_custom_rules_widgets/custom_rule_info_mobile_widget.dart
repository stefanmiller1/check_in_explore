...
class CustomRuleInfoMobileEditor extends StatefulWidget {
  ...
  const CustomRuleInfoMobileEditor({super.key, required this.model, required this.activityManagerForm, required this.reservation, required this.didSave});

  @override
  State<CustomRuleInfoMobileEditor> createState() => _CustomRuleInfoMobileEditorState();
}

class _CustomRuleInfoMobileEditorState extends State<CustomRuleInfoMobileEditor> {
