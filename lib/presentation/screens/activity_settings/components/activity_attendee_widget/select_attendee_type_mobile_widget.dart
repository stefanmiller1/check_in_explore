...
class AttendeeTypeMobileEditor extends StatefulWidget {
  ...
  const AttendeeTypeMobileEditor({super.key, required this.model, required this.activityManagerForm, required this.reservation, required this.didSave});

  @override
  State<AttendeeTypeMobileEditor> createState() => _AttendeeTypeMobileEditorState();
}

class _AttendeeTypeMobileEditorState extends State<AttendeeTypeMobileEditor> {
