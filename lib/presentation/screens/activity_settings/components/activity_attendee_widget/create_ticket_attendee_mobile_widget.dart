...
class TicketAttendeeMobileEditor extends StatefulWidget {
  ...
  const TicketAttendeeMobileEditor({super.key, required this.model, required this.activityManagerForm, required this.reservation, required this.didSave});

  @override
  State<TicketAttendeeMobileEditor> createState() => _TicketAttendeeMobileEditorState();
}

class _TicketAttendeeMobileEditorState extends State<TicketAttendeeMobileEditor> {
