...
class ActivityAddClassBackgroundInfo extends StatefulWidget {
  ...
  const ActivityAddClassBackgroundInfo({Key? key, required this.model, required this.activityCreatorForm}) : super(key: key);
                      ...
                      Row(
                        children: [
                          Container(
                              ...
                              width: 60,
                              child: Center(
                                child: Text(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityBackground.classActivityBackground?.numberOfYearsInExperience.toString() ?? '1', style: TextStyle(color: widget.model.disabledTextColor)
                                ),
                              )
                          ),
                          QuantityButtons(
                              model: widget.model,
                              initNumber: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityBackground.classActivityBackground?.numberOfYearsInExperience,
                              counterCallback: (int v) {
                                setState(() {
                                  context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.classNumberOfYearsExperienceChanged(v));
                                });
                              }
                          ),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              SizedBox(height: 20),
                              ...context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityBackground.classActivityBackground?.experience.asMap().map((i, e) {
                                ...
                                if (experienceTextController.text.isEmpty) {
                                  experienceTextController.text = context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityBackground.classActivityBackground?.experience[i].experienceTitle.value.fold(
                                                    ...
                                                    children: [
                                                      ...
                                                      Container(
                                                        ...
                                                        child: TextButton(
                                                                    ...
                                                                    return AlertDialog(
                                                                      ...
                                                                      content: Container(
                                                                        ...
                                                                        child: SfDateRangePicker(
                                                                          initialSelectedRange: PickerDateRange(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityBackground.classActivityBackground?.experience[i].experiencePeriod.start, context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityBackground.classActivityBackground?.experience[i].experiencePeriod.end),
                                                                          ...
                                                                          onSelectionChanged: (
                                                                            ...
                                                                            if (args.value is PickerDateRange) {
                                                                              ...
                                                                              setState(() {
                                                                                context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityBackground.classActivityBackground!.experience[i] = context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityBackground.classActivityBackground!.experience[i].copyWith(
                                                                                    experiencePeriod: DateTimeRange(start: rangeStartDate, end: rangeEndDate));
                                                                                context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.classExperienceChanged(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityBackground.classActivityBackground?.experience ?? []));
                                                                              });
                                                          ...
                                                          child: Row(
                                                            children: [
                                                              Expanded(child: Text(DateFormat.y().format(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityBackground.classActivityBackground!.experience[i].experiencePeriod.start), style: TextStyle(color: widget.model.paletteColor, fontWeight: FontWeight.bold, fontSize: widget.model.secondaryQuestionTitleFontSize))),
                                                    ...
                                                    children: [
                                                      ...
                                                      Container(
                                                        ...
                                                        child: TextButton(
                                                          ...
                                                          child: Row(
                                                            children: [
                                                              Expanded(child: Text(DateFormat.y().format(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityBackground.classActivityBackground!.experience[i].experiencePeriod.end), style: TextStyle(color: widget.model.paletteColor, fontWeight: FontWeight.bold, fontSize: widget.model.secondaryQuestionTitleFontSize))),
                                                              Icon(Icons.calendar_today_rounded, color: widget.model.paletteColor),
                                                            ],
                                                          ),
                                                        ),
                                              ...
                                              IconButton(
                                                ...
                                                onPressed: () {
                                                  setState(() {
                                                    ...
                                                    context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityBackground.classActivityBackground?.experience.removeAt(i);
                                                    context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.classExperienceChanged(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityBackground.classActivityBackground?.experience ?? []));
                              ...
                              SizedBox(height: 10),
                              Visibility(
                                visible: ((context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityBackground.classActivityBackground?.experience.length ?? 1) < 5),
                                child: TextButton(
                                  style: ButtonStyle(
                                      backgroundColor: MaterialStateProperty.resolveWith<Color>(
                                            (Set<MaterialState> states) {
                                  ...
                                  onPressed: () {
                                    setState(() {
                                      context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityBackground.classActivityBackground?.experience.add(ExperienceOption(experiencePeriod: DateTimeRange(start: DateTime.now().subtract(Duration(days: 365)), end: DateTime.now()), experienceTitle: FirstLastName('')));
                                      context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.classExperienceChanged(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityBackground.classActivityBackground?.experience ?? []));
                                    });
                                  },
                              ...
                              SizedBox(height: 20),
                              ...context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityBackground.classActivityBackground?.certificates.asMap().map((i, value) {
                                TextEditingController certificateTextController = TextEditingController();

                                if (certificateTextController.text.isEmpty) {
                                  certificateTextController.text = context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityBackground.classActivityBackground?.certificates[i].certificateTitle.value.fold(
                                          (l) => l.maybeMap(userProfile: (e) => e.f?.maybeMap(invalidLegalName: (e) => e.failedValue, empty: (e) => e.failedValue, orElse: () => '') ?? '', orElse: () => ''),
                                          (r) => r) ?? '';
                                }
                                            ...
                                            child: DropdownButtonHideUnderline(
                                                child: DropdownButton2(
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: Row(
                                                          ...
                                                          children: [
                                                            Padding(
                                                              padding: const EdgeInsets.only(left: 8.0),
                                                              child: Text(getCertificateName(context, context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityBackground.classActivityBackground?.certificates[i].certificateType ?? CertificateType.Professional), style: TextStyle(color: widget.model.paletteColor, fontWeight: FontWeight.bold, fontSize: widget.model.secondaryQuestionTitleFontSize)),
                                                            ),
                                                            Padding(
                                                    ...
                                                    items: CertificateType.values.map(
                                                            ...
                                                            onTap: () {
                                                              setState(() {
                                                                context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityBackground.classActivityBackground?.certificates[i] = context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityBackground.classActivityBackground!.certificates[i].copyWith(certificateType: e);
                                                                context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.classCertificatesChanged(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityBackground.classActivityBackground?.certificates ?? []));
                                                              });
                                                            },
                                                            value: e,
                                          ...
                                          Expanded(
                                            child: getDescriptionTextField(
                                                ...
                                                updateText: (value) {
                                                  ...
                                                  context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityBackground.classActivityBackground?.certificates[i] = context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityBackground.classActivityBackground!.certificates[i].copyWith(
                                              ...
                                              child: IconButton(
                                                ...
                                                onPressed: () {
                                                  setState(() {
                                                    ...
                                                    context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityBackground.classActivityBackground?.certificates.removeAt(i);
                                                    context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.classCertificatesChanged(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityBackground.classActivityBackground?.certificates ?? []));
                              ...
                              SizedBox(height: 10),
                              Visibility(
                                visible: ((context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityBackground.classActivityBackground?.certificates.length ?? 1) < 5),
                                child: TextButton(
                                  style: ButtonStyle(
                                      backgroundColor: MaterialStateProperty.resolveWith<Color>(
                                            (Set<MaterialState> states) {
                                  ...
                                  onPressed: () {
                                    setState(() {
                                      context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityBackground.classActivityBackground?.certificates.add(CertificateOption(certificateType: CertificateType.Professional, dateReceived: DateTime.now(), certificateTitle: FirstLastName('')));
                                      context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.classCertificatesChanged(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityBackground.classActivityBackground?.certificates ?? []));
                                    });
                                  },
                                  child: Text(AppLocalizations.of(context)!.add, style: TextStyle(color: widget.model.accentColor, fontWeight: FontWeight.bold)),
