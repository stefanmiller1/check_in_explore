...
class ActivityRequirementEventSelling extends StatefulWidget {
  ...
  const ActivityRequirementEventSelling({Key? key, required this.model, required this.activityManagerForm, required this.reservation}) : super(key: key);
...
class _ActivityRequirementEventSellingState extends State<ActivityRequirementEventSelling> {
  ...
  //                       toggleable: true,
  //                       value: 'Yes',
  //                       groupValue: (context.read<UpdateActivityFormBloc>().state.activitySettingsForm.profileService.activityRequirements.eventActivityRulesRequirement?.isMerchantSupported ?? false) ? 'Yes' : null,
  //                       onChanged: (String? value) {
  //
  //                         if (context.read<UpdateActivityFormBloc>().state.activitySettingsForm.profileService.activityRequirements.eventActivityRulesRequirement?.isMerchantSupported ?? false) {
  ...
  //                       toggleable: true,
  //                       value: 'No',
  //                       groupValue: !(context.read<UpdateActivityFormBloc>().state.activitySettingsForm.profileService.activityRequirements.eventActivityRulesRequirement?.isMerchantSupported ?? false) ? 'No' : null,
  //                       onChanged: (String? value) {
  //
  //                           context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.isMerchantSupportedChanged(false));
  //
  ...
  //                     SizedBox(height: 20),
  //                     Visibility(
  //                       visible: (context.read<UpdateActivityFormBloc>().state.activitySettingsForm.profileService.activityRequirements.eventActivityRulesRequirement?.isMerchantSupported ?? false),
  //                       child: Column(
  //                         mainAxisAlignment: MainAxisAlignment.start,
  //                         crossAxisAlignment: CrossAxisAlignment.start,
  //                         children: [
  ...
  //
  //                               ],
  //                               rows: context.read<UpdateActivityFormBloc>().state.activitySettingsForm.profileService.activityRequirements.eventActivityRulesRequirement?.listOfMerchants.asMap().map((i, value) {
  //
  ...
  //                                                     setState(() {
  //
  //                                                       if ((context.read<UpdateActivityFormBloc>().state.activitySettingsForm.profileService.activityRequirements.eventActivityRulesRequirement?.listOfMerchants.length ?? 1) >= 2 && i != 0) {
  //
  //                                                         context.read<UpdateActivityFormBloc>().state.activitySettingsForm.profileService.activityRequirements.eventActivityRulesRequirement?.listOfMerchants.removeAt(i);
  //
  //                                                       } else {
  //
  //                                                         context.read<UpdateActivityFormBloc>().state.activitySettingsForm.profileService.activityRequirements.eventActivityRulesRequirement?.listOfMerchants[i] = context.read<UpdateActivityFormBloc>().state.activitySettingsForm.profileService.activityRequirements.eventActivityRulesRequirement!.listOfMerchants[i].copyWith(
  //                                                             contactId: UniqueId(),
  //                                                             name: FirstLastName(''),
  //                                                             position: '',
  ...
  //                                                       }
  //
  //                                                       // context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.merchantListChanged(context.read<UpdateActivityFormBloc>().state.activitySettingsForm.profileService.activityRequirements.eventActivityRulesRequirement?.listOfMerchants ?? []));
  //                                                     });
  //                                                   },
  ...
  //                               onPressed: () {
  //                                 setState(() {
  //                                   context.read<UpdateActivityFormBloc>().state.activitySettingsForm.profileService.activityRequirements.eventActivityRulesRequirement?.listOfMerchants.add(ContactDetails(contactId: UniqueId(), name: FirstLastName(''), emailAddress: EmailAddress('')));
  //                                   // context.read<UpdateActivityFormBloc>().add(UpdateActivityFormEvent.merchantListChanged(context.read<UpdateActivityFormBloc>().state.activitySettingsForm.profileService.activityRequirements.eventActivityRulesRequirement?.listOfMerchants ?? []));
  //                                 });
  //                               },
