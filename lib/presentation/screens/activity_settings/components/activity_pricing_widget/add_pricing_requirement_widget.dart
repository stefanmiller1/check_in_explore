...
class _ActivityAddPricingRequirementState extends State<ActivityAddPricingRequirement> {
  ...
  void rebuild(BuildContext context) {
    if (ticketBasedSlot?.text != context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityCost.defaultFeeTickets) {
      ticketBasedSlot?.text = context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityCost.defaultFeeTickets ?? '';
    }

    if (singlePassBasedSlot?.text != context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityCost.defaultFeePasses) {
      singlePassBasedSlot?.text = context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityCost.defaultFeePasses ?? '';
    }

    if (groupPassBasedSlot?.text != context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityCost.defaultFeeGroupPasses) {
      groupPassBasedSlot?.text = context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityCost.defaultFeeGroupPasses ?? '';
    }
    ...
    return Column(
      ...
      children: [
        ...
        RadioListTile(
          toggleable: true,
          value: 'Fixed',
          groupValue: (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityCost.isFixedHours ?? false) ? 'Fixed' : null,
          onChanged: (String? value) {

            setState(() {
              if (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityCost.isFixedHours ?? false) {
        ...
        RadioListTile(
          toggleable: true,
          value: 'Dynamic',
          groupValue: (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityCost.isDynamicHours ?? false) ? 'Dynamic' : null,
          onChanged: (String? value) {

            setState(() {

              if (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityCost.isDynamicHours ?? false) {
                context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.feeIsDynamicChanged(false));
                context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.feeIsStaticChanged(false));
              } else {
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: getTimeSlotAmount(
                            ...
                            AppLocalizations.of(context)!.facilityCostingEstimate('${(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAttendance.activityTickets?.ticketQuantity ?? 1) * 15 * 8}'),
                            context,
                            true,
                            false,
                            widget.model,
                    ...
                    Text('We Estimate \$${(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAttendance.activityTickets?.ticketQuantity ?? 1) * 15} Per Hour', style: TextStyle(color: widget.model.paletteColor, fontWeight: FontWeight.bold)),
                    Text('Up to ${context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAttendance.activityTickets?.ticketQuantity ?? 0} Attendees', style: TextStyle(color: widget.model.paletteColor)),

                    SizedBox(height: 20),
                    Visibility(
                      visible: (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityCost.isDynamicHours ?? false),
                      child: Container(
                        height: 40,
                        child: TextButton(
                          style: ButtonStyle(
                            ...
                            showDialog(
                                ...
                                builder: (BuildContext contexts) {
                                  return ActivityPricingPerHourFilterWidget(
                                    model: widget.model,
                                    selectedDayOfWeek: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.hoursOpen.openHours.where((element) => element.isClosed != true).map((e) => e.dayOfWeek).first,
                                    selectableWeekDay: [1,2,3,4,5,6,7],
                                    disabledWeekDays: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.hoursOpen.openHours.where((element) => element.isClosed != true).map((e) => e.dayOfWeek).toList(),
                                    selectedFeeOption: [],
                                    ...
                                    saveOptions: (List<CostPerHourSettingOption> savedList) {
                                      ...
                                      for (CostPerHourSettingOption weekDays in savedList) {
                                        ...
                                        int index = context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityCost.costSettingsRecurring.indexWhere((element) => element.dayOfWeek == weekDays.dayOfWeek);
                                        context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityCost.costSettingsRecurring.replaceRange(index, index+1, [CostPerHourSettingOption(dayOfWeek: weekDays.dayOfWeek, feeDuringHourRange: feeItem.toSet().toList())]);
                                      }

                                      setState(() {
                                        context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.feeRecurringSettingsChanged(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityCost.costSettingsRecurring.toSet().toList()));
        ...
        Visibility(
          visible: (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityCost.isDynamicHours ?? false),
          child: Column(
            children: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityCost.costSettingsRecurring.asMap().map(
                      (i, e) {
        ...
        Visibility(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Covers ${context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAttendance.activityPasses?.recurringNumberOfSessions ?? 0} Sessions', style: TextStyle(color: widget.model.paletteColor, fontSize: widget.model.secondaryQuestionTitleFontSize, fontWeight: FontWeight.bold)),
        ...
        SizedBox(height: 15),
        Visibility(
          visible: (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAttendance.isPassBased ?? false) && (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAttendance.activityPasses?.isAllowedGroupAttendance ?? false),
          child: Column(
            mainAxisAlignment: MainAxisAlignment.start,
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('Set Fee For Group Passes', style: TextStyle(color: widget.model.paletteColor, fontWeight: FontWeight.bold)),
              Text('${context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAttendance.activityPasses?.minimumGroupQuantity ?? 0} Attendees Min Per Group - ${context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAttendance.activityPasses?.maximumGroupQuantity ?? 0} Attendees Max Per Group', style: TextStyle(color: widget.model.paletteColor, fontWeight: FontWeight.bold)),
              Text('Covers ${context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAttendance.activityPasses?.recurringNumberOfSessions ?? 0} Sessions', style: TextStyle(color: widget.model.paletteColor, fontSize: widget.model.secondaryQuestionTitleFontSize, fontWeight: FontWeight.bold)),
              SizedBox(height: 7),
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: getTimeSlotAmount(
                            ...
                            AppLocalizations.of(context)!.facilityCostingPerSlot,
                            AppLocalizations.of(context)!.facilityCostingEstimate('${(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAttendance.activityTickets?.ticketQuantity ?? 1) * 30}'),
                            context,
                            true,
                            false,
                            widget.model,
  ...
  Widget getContainerForMultiDayEvent(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 25),
        Text('${AppLocalizations.of(context)!.facilityAvailableBookingsStarting}: ${DateFormat.yMMMMd().format(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting)}', style: TextStyle(color: widget.model.paletteColor, fontWeight: FontWeight.bold, fontSize: widget.model.questionTitleFontSize)),

        Text('${(DateTimeRange(start: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromStarting, end: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.fromEnding).duration.inDays/7).ceil()} Week ${getActivityOptions(context).where((element) => element.activity == context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityType.activity).first.title} Session', style: TextStyle(color: widget.model.paletteColor, fontWeight: FontWeight.bold, fontSize: widget.model.questionTitleFontSize)),
        SizedBox(height: 10),
        ...
        Container(
          ...
          child: Padding(
            padding: const EdgeInsets.all(8.0),
            child: Column(
              children: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.sessionDetails?.asMap().map(
        ...
        SizedBox(height: 10),
        Center(child: Text('${context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.sessionDetails?.length ?? 0} Sessions', style: TextStyle(color: widget.model.paletteColor, fontWeight: FontWeight.bold, fontSize: 60))),
        SizedBox(height: 10),
              ...
              Visibility(
                ...
                child: Column(
                  children: [
                    ...
                    ...context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityCost.costSettingsMulti.asMap().map((i, value) {
                              ...
                              children: [
                                              ...
                                              items: [for(var i=1; i<100; i+=1) i].where((element) => element != 0).map(
                                                      ...
                                                      onTap: () {
                                                        setState(() {
                                                          ...
                                                          context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityCost.costSettingsMulti[i] = context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityCost.costSettingsMulti[i].copyWith(
                                                              daysBeforeStartDate: e
                                                          );
                                                          context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.feeMultiDaySettingsChanged(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityCost.costSettingsMulti));
                                ...
                                Padding(
                                    ...
                                    child: IconButton(
                                        ...
                                        onPressed: () {
                                          setState(() {
                                            context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityCost.costSettingsMulti.removeAt(i);
                                            context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.feeMultiDaySettingsChanged(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityCost.costSettingsMulti));
                                        });
                                      }
                                    )
                    ...
                    TextButton(
                      ...
                      onPressed: () {
                        ...
                        setState(() {
                          context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityCost.costSettingsMulti.add(CostPerMultiDaySettingOption(daysBeforeStartDate: 10, feeBasedOnPass: '', isSinglePass: true, isGroupPass: false));
                          context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.feeMultiDaySettingsChanged(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityCost.costSettingsMulti));
                        });
        ...
        Visibility(
          visible: ((context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAttendance.activityPasses?.isAllowedGroupAttendance ?? false) && (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAttendance.isPassBased ?? false)),
          child: Center(
            child: Column(
              children: [
                SizedBox(height: 30),
                ...
                Visibility(
                  ...
                  child: TextButton(
                    ...
                    onPressed: () {
                      setState(() {
                        context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityCost.costSettingsMulti.add(CostPerMultiDaySettingOption(daysBeforeStartDate: 10, feeBasedOnPass: '', isSinglePass: false, isGroupPass: true));
                        context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.feeMultiDaySettingsChanged(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityCost.costSettingsMulti));
                      });
