...
class ActivitySetupExperienceContactDetails extends StatelessWidget {
  ...
  const ActivitySetupExperienceContactDetails({Key? key, required this.model, required this.activityCreatorForm}) : super(key: key);
...
class ActivitySetupExperienceOrgDetails extends StatelessWidget {
  ...
  const ActivitySetupExperienceOrgDetails({Key? key, required this.model, required this.activityCreatorForm}) : super(key: key);
