...
class ActivitySetupClassesWidget extends StatefulWidget {
  ...
  const ActivitySetupClassesWidget({Key? key, required this.model, required this.activityCreatorForm}) : super(key: key);
          ...
          body: Padding(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Visibility(
                      visible: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityType.activity == ProfileActivityOption.coaching,
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.start,
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          RadioListTile(
                            toggleable: true,
                            value: 'ExistingTeam',
                            groupValue: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.classesActivityAvailability?.coachExistingTeam ?? false ? 'ExistingTeam' : null,
                          ...
                          RadioListTile(
                            toggleable: true,
                            value: 'NewTeam',
                            groupValue: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.classesActivityAvailability?.coachNewTeam ?? false ? 'NewTeam' : null,
                            onChanged: (String? value) {
                              _selectedCoachNewTeam = value;
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      RadioListTile(
                        toggleable: true,
                        value: 'WorkingAlone',
                        groupValue: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.classesActivityAvailability?.isWorkingAlone ?? false ? 'WorkingAlone' : null,
                        onChanged: (String? value) {
                          // _selectedCoachNewTeam = value;
                      ...
                      RadioListTile(
                        toggleable: true,
                        value: 'WithHelp',
                        groupValue: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.classesActivityAvailability?.isWorkingWithAffiliates ?? false ? 'WithHelp' : null,
                        onChanged: (String? value) {
                          // _selectedCoachNewTeam = value;
                      ...
                      Visibility(
                        visible: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.classesActivityAvailability?.isWorkingWithAffiliates ?? false,
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.start,
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                                ...
                                onPressed: () {
                                  setState(() {
                                    ...
                                    if (affiliateOptionCreate != null && affiliateOptionCreate!.affiliateName.isNotEmpty && affiliateOptionCreate!.affiliateContact.isNotEmpty) {
                                      context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.classesActivityAvailability?.affiliateOptions.add(affiliateOptionCreate!);
                                      context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.classAffiliateOptionsChanged(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.classesActivityAvailability?.affiliateOptions ?? []));
                                      affiliateOptionCreate = affiliateOptionCreate?.copyWith(
                                          affiliateName: '',
                                          affiliateContact: ''
                                      );
                            ...
                            SizedBox(height: 20),
                            ...?context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.classesActivityAvailability?.affiliateOptions.map(
                                    (e) => Padding(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: TextButton(
                                              ...
                                              onPressed: () {
                                                setState(() {
                                                  context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.classesActivityAvailability?.affiliateOptions.remove(e);
                                                  context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.classAffiliateOptionsChanged(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.classesActivityAvailability?.affiliateOptions ?? []));
                                                });
                                              },
                      ...
                      RadioListTile(
                        toggleable: true,
                        value: 'NoLimit',
                        groupValue: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.classesActivityAvailability?.isOpenToUnlimitedAttendees ?? false ? 'NoLimit' : null,
                        onChanged: (String? value) {
                          // _selectedCoachNewTeam = value;

                          if (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.classesActivityAvailability?.isOpenToUnlimitedAttendees ?? false) {
                      ...
                      Visibility(
                        visible: !(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.classesActivityAvailability?.isOpenToUnlimitedAttendees ?? false),
                        child: Row(
                          children: [
                            Container(
                                decoration: BoxDecoration(
                                ...
                                width: 60,
                                child: Center(
                                  child: Text(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.classesActivityAvailability?.attendeeLimit.toString() ?? '3', style: TextStyle(color: widget.model.disabledTextColor)
                                  ),
                                )
                            ),
                            QuantityButtons(
                                model: widget.model,
                                initNumber: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.classesActivityAvailability?.attendeeLimit,
                                counterCallback: (int v) {

                                  setState(() {


                                    if ((context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.classesActivityAvailability?.playerRoster?.length ?? v) < v) {
                                    ...
                                    } else if ((context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.classesActivityAvailability?.playerRoster?.length ?? v) > v) {

                                      print('remove');
                                      context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.classesActivityAvailability?.playerRoster?.removeLast();
                                      context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.classPlayerRosterChanged(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.classesActivityAvailability?.playerRoster ?? []));
                                    }
              ...
              child: Column(
                ...
                children: [
                  ...
                  RadioListTile(
                    toggleable: true,
                    value: 'NoLimit',
                    groupValue: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.classesActivityAvailability?.isOpenToMorePlayers ?? false ? 'NoLimit' : null,
                    onChanged: (String? value) {

                      if (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.classesActivityAvailability?.isOpenToMorePlayers ?? false) {
                  ...
                  Visibility(
                    visible: !(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.classesActivityAvailability?.isOpenToMorePlayers ?? false),
                    child: Row(
                      children: [
                        Container(
                            decoration: BoxDecoration(
                            ...
                            width: 60,
                            child: Center(
                              child: Text(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.classesActivityAvailability?.additionalPlayerLimit.toString() ?? '8', style: TextStyle(color: widget.model.disabledTextColor)
                              ),
                            )
                        ),
                        QuantityButtons(
                            model: widget.model,
                            initNumber: context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.classesActivityAvailability?.additionalPlayerLimit ?? 8,
                            counterCallback: (int v) {
                  ...
                  SingleChildScrollView(
                    ...
                    child: DataTable(
                        ...
                        rows: (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.classesActivityAvailability?.playerRoster != null) ? context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.classesActivityAvailability?.playerRoster?.asMap().map((i, value) {
                                        ...
                                        child: TextButton(
                                            ...
                                            onPressed: () {
                                              ...
                                              setState(() {
                                                ...
                                                if (i != 0 && (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.classesActivityAvailability?.playerRoster?.length ?? 1) >= (context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.classesActivityAvailability?.attendeeLimit ?? 3)) {
                                                  context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.classesActivityAvailability?.playerRoster?.removeAt(i);
                                                } else {
                  ...
                  Visibility(
                    ...
                    child: Center(
                      child: TextButton(
                        ...
                        onPressed: () {
                          setState(() {
                            context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.classesActivityAvailability?.playerRoster?.add(ContactDetails(contactId: UniqueId(), name: FirstLastName(''), emailAddress: EmailAddress('')));
                            context.read<UpdateActivityFormBloc>()..add(UpdateActivityFormEvent.classPlayerRosterChanged(context.read<UpdateActivityFormBloc>().state.activityCreatorForm.activityAvailability.classesActivityAvailability?.playerRoster ?? []));
                          });
                        },
