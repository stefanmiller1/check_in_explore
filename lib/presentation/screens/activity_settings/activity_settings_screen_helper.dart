...
List<ActivityCreatorFormNav> getMenuItems(BuildContext context) {
  ...
  UpdateActivityFormState formState = context.read<UpdateActivityFormBloc>().state;
  ...
  if (formState.activityCreatorForm.activityType.activityType != ProfileActivityTypeOption.toRent) {
  ...
  if (formState.activityCreatorForm.activityAvailability.isActive) {
  ...
  /// *** game based rules *** ///
  if (formState.activityCreatorForm.activityType.activityType == ProfileActivityTypeOption.gameMatches) {
