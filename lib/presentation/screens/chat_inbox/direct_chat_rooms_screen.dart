...
//   final String? currentSelectedRoom;
//   final RoomsFilterObject? currentFilterObject;
//   final Function(types.Room room, UserProfileModel user) didSelectRoom;

//   const DirectChatRoomsScreen({super.key, required this.model, required this.currentUser, required this.currentSelectedRoom, required this.didSelectRoom, this.currentFilterObject});
...
//           stream: facade.FirebaseChatCore.instance.rooms(orderByUpdatedAt: (widget.currentFilterObject?.reverseQueryOrder != null) ? (widget.currentFilterObject?.reverseQueryOrder == true) : true , isArchived: widget.currentFilterObject?.isArchive == true),
...
//                                     widget.model,
//                                     room,
//                                     widget.currentSelectedRoom == room.id,
//                                     hasReadLastMessages,
//                                     false,
...
//   //                                       widget.model,
//   //                                       room,
//   //                                       RoomsHelperCore.selectedRoom == room,
//   //                                       hasReadLastMessages,
//   //                                       false,
//   //                                       messageSnapshot.data ?? [],
//   //                                       dates,
