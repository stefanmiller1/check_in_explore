...
class _SettingsMainContainerWidgetState extends State<SettingsMainContainerWidget> {
  ...
  Widget build(BuildContext context) {
    return (widget.userProfileModel.userId != widget.reservationItem.reservationId) ? BlocProvider(create: (context) => getIt<UserProfileWatcherBloc>()..add(UserProfileWatcherEvent.watchSelectedUserProfileStarted(widget.reservationItem.reservationOwnerId.getOrCrash())),
