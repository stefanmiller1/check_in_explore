...
import 'package:check_in_web_mobile_explore/presentation/screens/search_explore/components/listing_result_main.dart';
...
class ListingResultMainCard extends StatefulWidget {
  ...
  const ListingResultMainCard({super.key, required this.isLoading, required this.model, this.currentUser, required this.listing});
                        ...
                        Navigator.push(context, HeroDialogRoute(
                            ...
                            builder: (context) {
                              return FacilityPreviewScreen(
                                  listing: widget.listing,
                                  marker: Marker(markerId: MarkerId(widget.listing.listingServiceId.getOrCrash()), position: LatLng(widget.listing.listingProfileService.listingLocationSetting.locationPosition?.latitude ?? 0, widget.listing.listingProfileService.listingLocationSetting.locationPosition?.longitude ?? 0)),
                                  model: widget.model,
